...
Read, then run the script:
    ...
    bash <(curl -s https://raw.githubusercontent.com/gregovich/laptop/master/mac) 2>&1 | tee ~/laptop.log

### Linux

Read, then run the script:

    bash <(wget -qO- https://raw.githubusercontent.com/gregovich/laptop/master/linux) 2>&1 | tee ~/laptop.log
